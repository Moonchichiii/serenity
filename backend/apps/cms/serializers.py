...
class HomePageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HomePage
        # Fixed RUF012: Converted fields list to tuple
        fields = (
            # Hero
            'hero_title_en',
            'hero_title_fr',
    ...
    def to_representation(self, instance: HomePage) -> dict[str, Any]:
        ...
        # Maintain consistent ordering via sort_order
...
class GiftSettingsSerializer(serializers.ModelSerializer):
    ...
    def get_floating_icon(self, obj: GiftSettings) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.exception('Failed to generate Cloudinary URL for floating_icon')
            return None
