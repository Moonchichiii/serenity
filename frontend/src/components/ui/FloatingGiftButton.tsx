...
export function FloatingGiftButton() {
  ...
  return (
    <button
      type="button"
      onClick={() => open("gift")}
      className="group fixed bottom-6 right-6 z-40 animate-fade-in-scale transition-transform duration-200 ease-out hover:scale-105 active:scale-95 sm:bottom-10 sm:right-10"
      aria-label={label}
      title={label}
    >
