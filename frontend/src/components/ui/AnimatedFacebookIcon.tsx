    ...
    return (
        ...
        >
            <motion.div
                ...
                style={{
                    background: 'linear-gradient(135deg, #3b5998 0%, #1877f2 40%, #0052cc 100%)',
            ...
            <motion.div
                className="absolute inset-0 rounded-full"
                style={{
                    background: 'radial-gradient(60% 60% at 50% 50%, rgba(24, 119, 242, 0.35), transparent 70%)',
                    filter: 'blur(8px)',
                }}
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: hovered
                        ? '0 14px 28px -12px rgba(24,119,242,0.35)'
                        : '0 8px 20px -12px rgba(59,89,152,0.28)',
                }}
            >
                <Facebook
